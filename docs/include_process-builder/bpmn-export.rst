...
You can export a Signavio Workflow process model as a BPMN 2.0 XML file.
...
To export a process model, first open it in the Signavio Workflow process editor.
...
Signavio Workflow only exports one kind of BPMN file, so it doesn’t give you any options to configure.
