...
Signavio Workflow Accelerator includes some of these examples within the application, so you don’t have to start from scratch when you develop your first process model.
These examples may also give you some inspiration for how to use Workflow Accelerator’s features in your own models.
