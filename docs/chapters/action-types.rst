...
- Form: A task can be given a form.
  To complete the task, the form has to be submitted.
- Reminders: Reminder emails and escalations.
...
- To: The people to which the email is sent.
...
- Attachments: To add attachments, click the attachments field.
...
- Body text: Just like in the subject, you can combine template text with variable fields to Start by typing a #.
