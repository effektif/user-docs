# -*- coding: utf-8 -*-
#
# Effektif User Guide documentation build configuration file, created by
...
# of the sidebar.
html_logo = '_static/_images/signavio-logo-small.svg'
...
html_extra_path = ['examples.html', 'include_cases/search.html']
