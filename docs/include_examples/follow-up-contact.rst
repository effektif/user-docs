...
Although a simple to do list application might provide enough functionality for this scenario, using Workflow Accelerator gives you the benefit on a case view that conveniently collects more information about each contact, but without the complexity of a full-featured sales pipeline tool.
