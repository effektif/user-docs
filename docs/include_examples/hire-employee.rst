...
If the hiring manager rejects the applicant at either stage, Workflow Accelerator sends a standard rejection email.
...
* *Candidate email* (Email address, mandatory) - the email address that Workflow Accelerator uses to send a rejection email.
